<div class="kt-header__topbar-item kt-header__topbar-item--user">
		...
		<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl show" x-placement="bottom-end" style="position: absolute; transform: translate3d(1011px, 79px, 0px); top: 0px; left: 0px; will-change: transform;">
			<!--begin: Head -->
