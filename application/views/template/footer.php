            ...
            <div class="row">
                <div class="col-lg-4">
                    <div  class="kt-footer__section">
                        <h3 class="kt-footer__title">Visi</h3>
                        <div class="kt-footer__content">
                         Visi dari Badan Pengembangan Sumber Daya Manusia Daerah Provinsi Kalimantan Selatan yaitu “Kalsel Mapan (Mandiri dan Terdepan) Lebih Sejahtera, Berkeadilan, Berdikari dan Berdaya Saing”                          
                     </div>
                 </div>
             </div>
             <div class="col-lg-6">
                <div  class="kt-footer__section">
                    <h3 class="kt-footer__title">Misi</h3>
                    <div class="kt-footer__content">
                        Misi Dinas Tanaman Pangan dan Hortikultura Provinsi Kalimantan Selatan adalah :
                       <ol style="margin-left: -20px">
                           <li>Mengembangkan Sumber Daya Manusia yang Agamis, Sehat, Cerdas dan Terampil;</li>
                           <li>Mewujudkan Tatakelola Pemerintah yang Professional dan Berorientasi pada Pelayanan Publik;</li>
                           <li>Mengembangkan Infarstruktur Wilayah yang Mendukung Percepatan Pengembangan Ekonomi dan Sosial Budaya;</li>
                           <li>Mengembangkan Infrastruktur Wilayah Yang Mendukung Percepatan Pengembangan Ekonomi dan Sosial Budaya; dan</li>
                           <li> Mengembangkan Daya Saing Ekonomi Daerah yang Berbasis Sumberdaya Lokal, dengan Memperhatikan Kelestarian Lingkungan</li>
                       </ol>
                   </div>
               </div>
           </div>
                ...
                <div class="kt-footer__content">
                    <div class="kt-footer__nav">
                        <div class="kt-footer__nav-section">
                            <a href="https://bpsdm.kalselprov.go.id/">Situs BPSDMD</a>
