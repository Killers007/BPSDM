...
<base href="../../../../"><!--end::Base Path -->
    ...
    <title>SI PENDAFTARAN DIKLAT</title>
            ...
            <div class="kt-login__container">
                ...
                <div class="kt-login__signup">
                    ...
                    <form class=" kt-form formRegister" onsubmit="return false">
                            <div class="input-group">
                                <input class="form-control is-invalid" type="text" placeholder="Nama Lengkap" name="pesertaNama">
                            ...
                            <div class="row kt-login__extra">
                                <div class="col kt-align-left">
                                    <label class="kt-checkbox">
                                        <input type="checkbox" name="agree">Saya setuju dengan ketentuan dan syarat pendaftaran Peserta DIKLAT</a>.
                                        <div class="invalid-feedback cleanError agree" style="display: block;"></div>
                                        <span></span>
                                    </label>
                            ...
                            <div class="kt-login__actions">
                                ...
                                <button id="kt_login_signup_cancel" class="btn btn-secondary btn-pill kt-login__btn-secondary">Batal</button>
                            </div>
                        </form>
                </div>
...
<!--begin::Global Theme Bundle(used by all pages) -->
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btnRegister', function(event) {
            ...
            $.ajax({
                url: '<?php echo current_url() ?>/register',
                type: 'POST',
                dataType: 'JSON',
                data: data,
                beforeSend: function()
