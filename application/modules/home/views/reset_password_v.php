                ...
                <div class="kt-login__container">
                    ...
                    <div class="kt-login__signin">
                        <div class="kt-login__head">
                            <h3 class="kt-login__title">Ganti Password</h3>
                        </div>
                        <form class="kt-form formLogin" onsubmit="return false">
                            <div class="input-group">
                                <input class="form-control is-invalid" type="password" placeholder="Password" name="password"  autocapitalize="off">
                                <div class="invalid-feedback cleanError password"></div>
                            </div>
                            <div class="input-group">
                                <input class="form-control is-invalid" type="password" placeholder="Konfirmasi Password" name="repassword">
                                <div class="invalid-feedback cleanError repassword"></div>
                            </div>
                           
                            <div class="kt-login__actions">
                                <button id="btnLogin" class="btn btn-brand btn-pill kt-login__btn-primary">Simpan</button>
                            </div>
                        </form>
                    </div>
...
<script src="<?php echo base_url() ?>assets/js/demo4/pages/login/login-general.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btnLogin', function(event) {
            ...
            $.ajax({
                url: '<?php echo base_url('home/reset/?uid='.$this->input->get('uid').'&token='.$this->input->get('token')) ?>',
                type: 'POST',
                dataType: 'JSON',
                data: data,
                beforeSend: function()
        ...
        $(document).on('click', '#btnReset', function(event) {
            ...
            $.ajax({
                ...
                complete: function()
                {
                    toastr['error']('Terjadi kesalahan pada koneksi');
