...
<!-- <div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                : `+d.pegawaiTempatLahir+`, `+moment(d.pegawaiTanggalLahir).locale('id').format('dddd D MMMM YYYY')+`
            </div>
        </div>
        <div class="row">
            <div class="col-sm-2">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#table').dataTable({
            ...
            },
            {
                data: null, searchable: false, orderable: false, render: function (data) {
                    ...
                    var text = '';
                    var foto = (data.pegawaiFoto == null)?'./assets/media/users/default.jpg':'<?php echo base_url('assets/upload/images') ?>/'+data.pegawaiFoto;
                    ...
                    <span class="kt-user-card-v2__name">`+ data.pegawaiGelarDepan+' '+data.pegawaiNama+' '+data.pegawaiGelarBelakang+`</span>
                    <a href="#" class="kt-user-card-v2__email kt-link">`+data.pegawaiUsername+`</a>
                    </div>
                    </div>`;
            ...
            {data: 'pegawaiPangkatGolongan'},
            {data: 'pegawaiJabatan'},
            {data: 'pegawaiInstansi'},
            // {
            //     data: null, searchable: false, orderable: false, render: function (data) {

            //         var btnUbah =  `<a onclick="setTitle('Perbaharui', 'Perbaharui')" data-id="`+data.pegawaiUsername+`" class="btnEdit btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
            //         <i style="color: #366CF3;"class="la la-edit"></i>
            //         </a> `;

            //         var btnDelete =  `<a data-id="`+data.pegawaiUsername+`" class="btnDelete btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete">
        ...
        function format ( d ) {
            var text = '';
            var foto = (d.pegawaiFoto == null)?'./assets/media/users/default.jpg':'<?php echo base_url('assets/upload/images') ?>/'+d.pegawaiFoto;
            var tentang = (d.pegawaiTentang == null)?'':d.pegawaiTentang;
                                    ...
                                    <div class="kt-widget__content">
                                        <div class="kt-widget__head">
                                            <a href="#" class="kt-widget__username">
                                                `+d.pegawaiGelarDepan+' '+d.pegawaiNama+' '+d.pegawaiGelarBelakang+`    
                                        ...
                                        <div class="kt-widget__subhead">
                                            <a href="#"><i class="la la-key"></i>`+d.pegawaiUsername+`</a>
                                            <a href="#"><i class="flaticon2-new-email"></i>`+d.pegawaiEmail+`</a>
                                            <a href="#"><i class="fa fa-user-tie"></i>`+d.pegawaiJabatan+` </a>
                                            <a href="#"><i class="fa fa-phone-alt"></i>+62 `+d.pegawaiNoHp+` </a>
                                        </div>
                                ...
                                <div class="kt-widget__bottom">
                                   <div class="kt-widget__item">
                                        ...
                                        <div class="kt-widget__details">
                                            ...
                                            <span class="kt-widget__value">`+d.pegawaiPangkatGolongan+`</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="kt-widget__item">
                                        ...
                                        <div class="kt-widget__details">
                                            ...
                                            <span class="kt-widget__value">`+d.pegawaiInstansi+`</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="kt-widget__item">
                                        ...
                                        <div class="kt-widget__details">
                                            ...
                                            <span class="kt-widget__value">`+d.pegawaiPendidikanTerakhir+`</span>
                                        </div>
                                    </div>
                                    <div class="kt-widget__item">
                                        <div class="kt-widget__icon">
                                        ...
                                        <div class="kt-widget__details">
                                            ...
                                            <span class="kt-widget__value">`+d.pegawaiAlamat+`</span>
                                        </div>
                                    </div>
                                    <div class="kt-widget__item">
                                        <div class="kt-widget__icon">
                                        ...
                                        <div class="kt-widget__details">
                                            ...
                                            <span class="kt-widget__value">`+d.pegawaiAlamatKantor+`</span>
                                        </div>
                                    </div>
        ...
        $(document).on('click', '.btnEdit', function(event) {
            ...
            $('.datePicker').val(moment(find.pegawaiTanggalLahir).locale('id').format('D MMMM YYYY'));
        });
        ...
        function template(data)
        {
            ...
            var key   = ['pegawaiUsername', 'pegawaiNama', 'pegawaiJabatan'];
