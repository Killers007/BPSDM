	...
	<page size="A4">
		<table width="100%" border="5px" id="header">
			<tbody>
				<tr>
					<td align="center">
						<b style="font-size:25px;">DAFTAR HADIR PEMBELAJARAN <br>DIKLAT <?php echo $detailDiklat->diklatNama ?></b> 
						<br>
				...
				<table class="table table-bordered" style="width: 100%">
					...
					<tbody>
						<?php if (empty($dataPeserta)): ?>
							<tr>
								<td colspan="6" style="vertical-align: middle;" class="text-center">Tidak ada peserta</td>
							</tr>
						<?php endif ?>
		...
		<div class="row clearfix">
			<div class="col-md-12">
				<table style="width: 100%">
						<tr>
							<td style="vertical-align: middle; color: red" class="text-left">Diklat <?php echo $detailDiklat->diklatNama ?></td>
